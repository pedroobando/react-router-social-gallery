...
export const action = async ({ request }: Route.ActionArgs) => {
  ...
  // const verifypass = form.get('verifypass') ?? '';

  // console.log('servidor', email, password, verifypass);

  const newUser: UserRegister = {
    email: email.toString(),
    password: password.toString(), // Password should be hashed in a real application
  };
...
const AuthSignUp = ({ actionData }: Route.ComponentProps) => {
